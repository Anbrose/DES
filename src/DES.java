...
public class DES {
    ...
    private int plaintext_time=0;
    private char[] pc_1;
    private char[] Ipl;
    private char[] Ipr;
    private char[] E_Box;
    private char[] plaintext =new char[64];
    private ArrayList<Character[]> L=new ArrayList<>();
    private ArrayList<Character[]> R=new ArrayList<>();
    ...
    public void PC_1(){
        ...
        char[] Pc_1Table={57,49,41,33,25,17,9,1,58,50,42,34,26,18,
                ...
                14,6,61,53,45,37,29,21,13,5,28,10,12,4};
        char[] c3=new char[56];
        for (int i=0;i<56   ;i++){
    ...
    public void PC_2(){
        ...
        Character[] key2=new Character[48];
        for(int i=0;i<48;i++){
